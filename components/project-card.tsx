        ...
        <div className="relative h-full flex flex-col">
          <div className="relative overflow-hidden h-48">
            ...
            {image ? (
              ...
              <div
                className={`flex h-full w-full items-end bg-[radial-gradient(circle_at_25%_20%,rgba(168,85,247,0.42),transparent_34%),radial-gradient(circle_at_78%_35%,rgba(236,72,153,0.34),transparent_36%),linear-gradient(135deg,rgba(39,39,42,0.95),rgba(24,24,27,0.95))] p-6 transition-transform duration-700 ${
                  isHovered ? "scale-105" : "scale-100"
                }`}
              >
                <div className="space-y-2">
                  <div className="text-xs font-semibold uppercase tracking-widest text-white/45">Proyecto destacado</div>
                  <div className="text-2xl font-bold leading-tight text-white/90">{tags.slice(0, 2).join(" · ")}</div>
                </div>
              </div>
            )}
          </div>
